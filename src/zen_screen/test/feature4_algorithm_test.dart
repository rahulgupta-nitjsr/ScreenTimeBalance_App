...
void main() {
  group('Feature 4: Core Earning Algorithm - Unit Tests', () {
    ...
    group('TC033: Sleep time earning calculation', () {
      test('8 hours sleep should earn 200 minutes (8 * 25) but be capped at 120', () {
        ...
        // 8 hours = 200 minutes earned, but capped at daily maximum of 120 minutes
      ...
      test('6 hours sleep should earn 150 minutes (6 * 25) but be capped at 120', () {
        final minutesByCategory = {
        ...
        // 6 hours = 150 minutes earned, but capped at daily maximum of 120 minutes
        expect(result.totalEarnedMinutes, equals(120));
      ...
      test('More than 9 hours sleep should apply penalty', () {
        ...
        // 9 hours = 225 minutes earned, minus 20 penalty = 205 minutes, but capped at 120
        expect(result.totalEarnedMinutes, equals(120));
    ...
    group('TC039: Daily cap/penalty enforcement', () {
      test('Should enforce daily cap of 120 minutes without POWER+ Mode', () {
        final minutesByCategory = {
          HabitCategory.sleep: 300,    // 5 hours (does not meet 7-hour goal)
        ...
        // No goals met, so no POWER+ Mode, capped at 120
        expect(result.totalEarnedMinutes, lessThanOrEqualTo(120));
        expect(result.powerModeUnlocked, isFalse);
      });
